(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? module.exports = factory(require('core-js/modules/es.array.concat'), require('core-js/modules/es.array.filter'), require('core-js/modules/es.array.includes'), require('core-js/modules/es.array.index-of'), require('core-js/modules/es.array.is-array'), require('core-js/modules/es.array.iterator'), require('core-js/modules/es.array.join'), require('core-js/modules/es.array.map'), require('core-js/modules/es.array.splice'), require('core-js/modules/es.date.to-json'), require('core-js/modules/es.date.to-string'), require('core-js/modules/es.number.constructor'), require('core-js/modules/es.number.is-finite'), require('core-js/modules/es.number.is-integer'), require('core-js/modules/es.object.assign'), require('core-js/modules/es.object.entries'), require('core-js/modules/es.object.keys'), require('core-js/modules/es.object.to-string'), require('core-js/modules/es.promise'), require('core-js/modules/es.regexp.exec'), require('core-js/modules/es.regexp.to-string'), require('core-js/modules/es.string.includes'), require('core-js/modules/es.string.iterator'), require('core-js/modules/es.string.pad-start'), require('core-js/modules/es.string.repeat'), require('core-js/modules/es.string.replace'), require('core-js/modules/es.weak-map'), require('core-js/modules/es.weak-set'), require('core-js/modules/web.dom-collections.iterator'), require('core-js/modules/web.immediate'), require('core-js/modules/web.url.to-json'), require('stream')) :
  typeof define === 'function' && define.amd ? define(['core-js/modules/es.array.concat', 'core-js/modules/es.array.filter', 'core-js/modules/es.array.includes', 'core-js/modules/es.array.index-of', 'core-js/modules/es.array.is-array', 'core-js/modules/es.array.iterator', 'core-js/modules/es.array.join', 'core-js/modules/es.array.map', 'core-js/modules/es.array.splice', 'core-js/modules/es.date.to-json', 'core-js/modules/es.date.to-string', 'core-js/modules/es.number.constructor', 'core-js/modules/es.number.is-finite', 'core-js/modules/es.number.is-integer', 'core-js/modules/es.object.assign', 'core-js/modules/es.object.entries', 'core-js/modules/es.object.keys', 'core-js/modules/es.object.to-string', 'core-js/modules/es.promise', 'core-js/modules/es.regexp.exec', 'core-js/modules/es.regexp.to-string', 'core-js/modules/es.string.includes', 'core-js/modules/es.string.iterator', 'core-js/modules/es.string.pad-start', 'core-js/modules/es.string.repeat', 'core-js/modules/es.string.replace', 'core-js/modules/es.weak-map', 'core-js/modules/es.weak-set', 'core-js/modules/web.dom-collections.iterator', 'core-js/modules/web.immediate', 'core-js/modules/web.url.to-json', 'stream'], factory) :
  (global = global || self, global.jsonStreamStringify = factory(null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, global.stream));
}(this, (function (es_array_concat, es_array_filter, es_array_includes, es_array_indexOf, es_array_isArray, es_array_iterator, es_array_join, es_array_map, es_array_splice, es_date_toJson, es_date_toString, es_number_constructor, es_number_isFinite, es_number_isInteger, es_object_assign, es_object_entries, es_object_keys, es_object_toString, es_promise, es_regexp_exec, es_regexp_toString, es_string_includes, es_string_iterator, es_string_padStart, es_string_repeat, es_string_replace, es_weakMap, es_weakSet, web_domCollections_iterator, web_immediate, web_url_toJson, stream) { 'use strict';
